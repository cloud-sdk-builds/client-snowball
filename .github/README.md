...
[`@aws-sdk/client-snowball`](https://www.npmjs.com/package/@aws-sdk/client-snowball/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JlCTlNY4L8km/LkS27cSN5vVzbP2NeLF+ebRgWSiOYIUjbbKVpPAal88dS83g6TP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-snowball": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.667.0/index.min.mjs": "sha384-JlCTlNY4L8km/LkS27cSN5vVzbP2NeLF+ebRgWSiOYIUjbbKVpPAal88dS83g6TP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-snowball/blob/refs/tags/3.667.0/LICENSE
```
