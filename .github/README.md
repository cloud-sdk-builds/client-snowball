...
[`@aws-sdk/client-snowball`](https://www.npmjs.com/package/@aws-sdk/client-snowball/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v8xO23eAu/sTrMkc2PWeteeO/kuAs44s8LD0IVMiFUSaAP7uD5N75mubsQJ8bBuO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-snowball": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-snowball@3.556.0/index.min.mjs": "sha384-v8xO23eAu/sTrMkc2PWeteeO/kuAs44s8LD0IVMiFUSaAP7uD5N75mubsQJ8bBuO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-snowball/blob/refs/tags/3.556.0/LICENSE
```
